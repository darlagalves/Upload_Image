    ...
    <div class="box1">
        <div class="box2">
            ...
            <form action="/login" method="post">
                ...
                <div class="container mt-4">
                    <label for="password" class="titulologar">Repetir Senha</label>
                    <input type="password" class="form-control" id="password2" name="password" placeholder="senha">
                </div>
                ...
                <div class="container mt-4">
                    <label for="text" class="titulologar">CRM</label>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js" integrity="sha384-STfVfM6h5tt0kFVKFhMC2QrdrChivcJ6HrmE1FfJvvL8hb2Bhq+2j7QWgwVQKCgf" crossorigin="anonymous"></script>
